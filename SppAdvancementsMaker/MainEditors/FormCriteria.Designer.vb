...
Partial Class FormCriteria
    ...
    Private Sub InitializeComponent()
        ...
        Me.ComboBoxTrigger.Items.AddRange(New Object() {"从酿造台取出药水", "在两个维度间旅行", "更改信标结构", "获得/消除状态效果", "进入方块", "不可能触发", "获得漂浮状态效果", "进入下界，然后返回主世界", "解锁配方", "每个游戏刻", "使用末影之眼", "玩家的位置", "上床睡觉", "召唤实体", "驯服动物", "繁殖动物", "治愈僵尸村民", "被实体杀死", "杀死实体", "被实体伤害", "伤害实体"})
